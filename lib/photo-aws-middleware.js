...
exports.profilePhotoDelete = function(req, res, next){
...
exports.bedroomPhotoUpload = function(req, res, next){
  ...
  function uploadFiles() {
    console.log('running upload files, i is ', i);
    ...
    .then(data => {
      ...
      .then(photo => {
        ...
        if (i < numFiles) uploadFiles();
          ...
          console.log('Upload successful! Returning photos to router', photoDataArray);
